...
def parse_log_line(line):
    ...
    if match:
        date, time, Event, originaldate ,originalTimeStamp,message = match.groups()
...
log_file_path = 'C:\\Users\\siva1\\Desktop\\Github\\text2excel\\demo_value.txt'  # Change this to your log file path
excel_file_path = 'c:\\Users\\siva1\\Desktop\\Github\\text2excel\\demo_value1.xlsx'  # Change this to your desired output file path
